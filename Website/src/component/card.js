...
const Card = () => {
  return (
    <div>
      <div class="container" id="container" style={{marginTop:"-100px"}}>
        {" "}
        <div class="d-lg-flex">
          {" "}
          <div class="card border-0 me-lg-4 mb-lg-0 mb-4" id="card2">
            {" "}
            ...
            <div class="content">
              ...
              <p class="text-muted mt-3">
                ...
                Vokalia and Consonant*ia, there live the blind texts.
              </p>{" "}
          ...
          <div class="card border-0 mb-lg-0 mb-4" id="card2">
            {" "}
            <div class="backgroundEffect"></div>{" "}
            <div class="pic">
              {" "}
